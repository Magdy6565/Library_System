 ...
 * @author zedan.net
 */
public class ViewLibrarian extends javax.swing.JFrame implements Nodes{
  private Nodes parent ;
  private final String [] coloumnNames ;
    /**
     * Creates new form ViewLibrarian
     */
    public ViewLibrarian(java.lang.String[] coloumnNames) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewLibrarian(null).setVisible(true);
            }
        });
    }
