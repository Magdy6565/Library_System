 ...
 * @author zedan.net
 */
public class ViewBooks extends javax.swing.JFrame implements Nodes {
   ...
   private Nodes parent ;
    ...
    public ViewBooks(java.lang.String[] coloumnNames) {
         initComponents();
  ...
  /*  public ViewBooks(java.lang.String[] coloumnNames) {
    ...
    private ViewBooks(Object object) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewBooks(null).setVisible(true);
            }
        });
    }
